...
<body>
	...
	<main style="min-height: 100vh; max-width: 100%;">
		...
		<form action="" method="POST" class="w-50" enctype="multipart/form-data">
			...
			<a href="quan_ly_bai_hoc.php?id_khoa_hoc=<?php echo $id_khoa_hoc ?>" class="btn btn-primary">Trở lại</a>
...
<?php
	...
	if (isset($_POST['saveBaiTap'])) {
		...
		if (isset($_POST['video'])) {
			...
			if ($ten_file_de_bai == "") {
				$kq.= "- Hãy chọn file đề bài bài tập bạn muốn tải lên!<br>";
				$flag3 = false;
			}
			else{
		...
		if ($flag1 == true && $flag2 == true && $flag3 == true) {
			insertDLBaiHoc($connect, $id_khoa_hoc, $ten_bai_tap, $video_type, $video_path, $de_bai_path, $noi_dung);
