...
<body>
			  ...
			  <?php
			  	...
			  	if (isset($_POST['send'])) {
			  		...
			  		if ($flag1 == true && $flag2 == true) {
			  			$SQL = "INSERT INTO ho_tro (username, tieu_de, noi_dung, thoi_gian) VALUES ('".$username."', '".$tieu_de."', '".$noi_dung."', '".date('Y-m-d H:i:s')."')";
	...
	<div class="container">
		...
		<p>
			...
			<br>
			- 0868.788.661 (Đức Anh)
			<br>
			- 0904.888.999 (Việt Hưng)
		</p>
		<br>
		<p>Email:</p>
		<br>
		<p>
			...
			<br>
			- Trinh5420@gmail.com (Đức Anh)
			<br>
			- Hung@gmail.com (Việt Hưng)
		</p>
		<br>
		<p>Mạng xã hội</p>
		<br>
		<p>
			...
			<br>
			- <a href="fb.com/ItzVanh">fb.com/ducc.anhh.69</a> (Đức Anh)
