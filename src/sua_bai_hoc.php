	...
	<main style="min-height: 100vh; max-width: 100%;">
		...
		<form action="" method="POST" class="w-50" enctype="multipart/form-data">
			...
			<div class="mb-3">
			  ...
			  <!-- <input type="text" class="form-control" id="editor" name="noi_dung" value="<?php echo $noi_dung_LBH ?>"> -->
			  <textarea id="editor" name="editor"><?php echo $noi_dung_LBH ?></textarea>
			</div>
	...
	if (isset($_POST['saveBaiTap'])) {
		...
		if (isset($_POST['video'])) {
			...
			if(isset($_POST['editor'])){
				$noi_dung = $_POST['editor'];
			}

		if ($flag1 == true && $flag2 == true && $flag3 == true) {
			updateDLBaiHoc($connect, $ten_bai_hoc, $video_type, $video_path, $de_bai_path, $id_bai_hoc, $noi_dung);
